...
#Region "Properties"
    ...
    Public Property TextureFile As String
        ...
        Set(value As String)
            ...
            If my_UseTexture And my_textureFile <> "" And my_openGL IsNot Nothing Then
                Try
...
#End Region
    ...
    ''' </summary>
    Public Sub GenerateGeometry(scene As GLScene, percent As Integer)
        my_openGL = scene.GL
        ...
        CreateVertexBuffer(GLScene.positionAttribute, percent)
        CreateNormalBuffer(GLScene.normalAttribute, percent)
    ...
    Private Sub CreateVertexBuffer(vertexAttributeLocation As UInteger, percent As Integer)
        CreateVertices(percent)
    ...
    Private Sub CreateNormalBuffer(normalAttributeLocation As UInteger, percent As Integer)
        CreateNormals(percent)
    ...
    Protected Overridable Function GetModelMatrix() As mat4
        ...
        If my_RotationAxis.x + my_RotationAxis.y + my_RotationAxis.z = 0 Then
    ...
    Public Sub SetVertexColors(palettefile As String, colorcount As Integer)
    ...
    Protected Overridable Sub CreateColors()
        ...
        If my_UseVertexColors And my_VertexColors IsNot Nothing Then
            ...
            For I As Integer = 0 To VertexCount - 1
                ...
                my_colors(I) = my_VertexColors(index) * CSng(my_VertexColorIntensity)
                my_colors(I).A = 255
            Next
        Else
            ReDim my_colors(VertexCount - 1)
    ...
    Protected MustOverride Sub CreateVertices(percent As Integer)

    Protected MustOverride Sub CreateNormals(percent As Integer)

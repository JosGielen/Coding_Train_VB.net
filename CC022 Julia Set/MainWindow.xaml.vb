...
Class MainWindow
    ...
    Private ConstRe As Double = 0.2
    Private ConstIm As Double = 0.565
...
#Region "Menu"
    ...
    Private Sub MnuResetScale_Click(sender As Object, e As RoutedEventArgs)
...
#Region "Controls"
    ...
    Private Sub BtnConstReUP_Click(sender As Object, e As RoutedEventArgs)
        Dim dummy As Double = Double.Parse(TxtConstRe.Text)
        dummy += 0.1
        TxtConstRe.Text = dummy.ToString()
    End Sub

    Private Sub BtnConstReDown_Click(sender As Object, e As RoutedEventArgs)
        Dim dummy As Double = Double.Parse(TxtConstRe.Text)
        dummy -= 0.1
        TxtConstRe.Text = dummy.ToString()
    End Sub

    Private Sub BtnConstImUp_Click(sender As Object, e As RoutedEventArgs)
        Dim dummy As Double = Double.Parse(TxtConstIm.Text)
        dummy += 0.1
        TxtConstIm.Text = dummy.ToString()
    End Sub

    Private Sub BtnConstImDown_Click(sender As Object, e As RoutedEventArgs)
        Dim dummy As Double = Double.Parse(TxtConstIm.Text)
        dummy -= 0.1
        TxtConstIm.Text = dummy.ToString()
    End Sub
...
#Region "Fractal Calculation"
    ...
    Private Sub BtnCalc_Click(sender As Object, e As RoutedEventArgs)
        ...
        If Started Then
            ...
            Double.TryParse(TxtConstRe.Text, ConstRe)
            Double.TryParse(TxtConstIm.Text, ConstIm)
    ...
    Private Function Julia(ByVal X0 As Double, ByVal Y0 As Double) As Double

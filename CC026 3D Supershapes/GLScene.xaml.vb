...
#Region "Utilities"
    ...
    Private Sub LoadDefaultShaders()
        Try
            ...
            Dim reader As StreamReader = New StreamReader(_assembly.GetManifestResourceStream("_3DSuperShape.PerPixel.vert"))
            Using reader
                my_VertexShader = reader.ReadToEnd()
            End Using
            reader = New StreamReader(_assembly.GetManifestResourceStream("_3DSuperShape.PerPixel.frag"))
            Using reader
